let SmsEncoding = (function () {
    ...
    SmsEncoding.detectEncoding = function (text) {
    ...
    SmsEncoding.count = function (text) {
        const encoding = SmsEncoding.detectEncoding(text);
    ...
    SmsEncoding.parts = function (text) {
        const encoding = SmsEncoding.detectEncoding(text);
        const length = SmsEncoding.count(text);
        let parts = 1;
